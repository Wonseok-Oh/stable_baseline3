...
class BaseAlgorithm(ABC):
    ...
    :param use_sde: Whether to use generalized State Dependent Exploration (gSDE)
        instead of meta_action noise exploration (default: False)
    :param sde_sample_freq: Sample a new noise matrix every n steps when using gSDE
        Default: -1 (only sample at the beginning of the rollout)
    :param supported_meta_action_spaces: The meta_action spaces supported by the algorithm.
    """
    ...
    def __init__(
        ...
        self.meta_action_space = None  # type: Optional[gym.spaces.Space]
        self.n_envs = None
        ...
        self.eval_env = None
        self.seed = seed
        self.meta_action_noise = None  # type: Optional[meta_actionNoise]
        ...
        if env is not None:
            ...
            if supported_meta_action_spaces is not None:
                assert isinstance(self.meta_action_space, supported_meta_action_spaces), (
                    f"The algorithm only supports {supported_meta_action_spaces} as meta_action spaces "
                    f"but {self.meta_action_space} was provided"
                )
            ...
            if self.use_sde and not isinstance(self.meta_action_space, gym.spaces.Box):
                raise ValueError("generalized State-Dependent Exploration (gSDE) can only be used with continuous meta_actions.")
    ...
    def _setup_learn(
        ...
        if self.meta_action_noise is not None:
    ...
    def set_env(self, env: GymEnv) -> None:
        ...
        check_for_correct_spaces(env, self.observation_space, self.meta_action_space)
    ...
    def predict(
        ...
        """
        Get the model's meta_action(s) from an observation
    ...
    def set_random_seed(self, seed: Optional[int] = None) -> None:
        ...
        (python, numpy, pytorch, gym, meta_action_space)
    ...
    def load(
        ...
        **kwargs,
        ...
        if "observation_space" not in data or "meta_action_space" not in data:
            raise KeyError("The observation_space and meta_action_space were not given, can't verify new environments")

        if env is not None:
            # Wrap first if needed
            env = cls._wrap_env(env, data["verbose"])
            # Check if given env is valid
            check_for_correct_spaces(env, data["observation_space"], data["meta_action_space"])
        else:
