...
class BaseCallback(ABC):
    ...
    def on_invoke(self) -> bool:
        """
        This method will be called by the model after each call to ``env.invoke()``.
        :return: If the callback returns False, training is aborted early.
        """
        self.n_calls += 1
        # timesteps start at zero
...
class EvalCallback(EventCallback):
    ...
    def _on_invoke(self) -> bool:
        ...
        if self.eval_freq > 0 and self.n_calls % self.eval_freq == 0:
            ...
            episode_rewards, episode_lengths, success_rate, mean_mission_time = evaluate_policy(
                self.model,
                self.eval_env,
            ...
            self.logger.record("eval/mean_mission_time", mean_mission_time)
